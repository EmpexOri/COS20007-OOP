...
using Testing; //Rename this to the namespace of your project (project name).

namespace Testing //This should match your NUnit test project name.
{
    [TestFixture]
    public class ProgramMain //Rename this appropriately.
    {
        /// <summary>
        /// FIELDS
